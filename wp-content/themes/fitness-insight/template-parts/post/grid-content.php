...
<?php $post_option = get_theme_mod( 'fitness_insight_grid_column','3_column');
            	...
            	<div class="overlay">
            		<div class="date-box">
            			...
            			<span class="entry-author"><i class="far fa-user"></i><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' )) ); ?>"><?php the_author(); ?></a></span>
          				<span class="entry-comments"><i class="fas fa-comments"></i> <?php comments_number( __('0 Comments','fitness-insight'), __('0 Comments','fitness-insight'), __('% Comments','fitness-insight')); ?></span>
        			</div>
            		<p><?php the_excerpt();?></p>
            	</div>
